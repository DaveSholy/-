...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'شكرا للأضافة ','Type البوت للسيرفر',`${client.users.size} Members`,'شكرا للأستخدامكم البوت','By: Robert | Shelby'];
    var i = -1;
    var j = 0;
